...
while (1) {
	...
	redraw(*screen, vec);
	  ...
	  T1.draw(screen);
       ...
       case 's': // test for Line constructor
       {  int a , b, c, d;
	  cin>>a, b, c, d;
	  Line Line1(a,b,c,d);
       }
    ...
    case 'Q': case 'q':
     ...
     catch(input_Format_error&input_Format_error)
     {
	cout<< "Input format error"
	    << input_Format_error.what() <<endl;
     }
    catch (invalid_coordinates_error&invalid_coordinates_error)
    {
       cout <<"Invalid coordinates error: "
	    << invalid_coordinates_error.what()<<endl;
    }
    catch (invalid_Line_error&invalid_Line_error )
    {
      cout <<"Invalid Line error: "
	    << invalid_Line_error.what()<<endl;
    }
    catch (invalid_screen_error&invalid_Screen_error)
    {
       cout <<"Invalid Screen error: "
	    << invalid_Screen_error.what()<<endl;
    }
